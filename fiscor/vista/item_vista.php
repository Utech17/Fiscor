                        ...
                        <tbody>
                            ...
                            if (isset($data) && is_array($data)) {
                                foreach ($data as $row) {
                                    ...
                                    echo "<td>
                                        <a onClick='buscarItem(this)' class='btn-azul' data-id='".$row['id_item']."' data-nombre='".$row['nombre']."' data-estado='".$row['estado']."' data-cantidad='".$row['cantidad']."' data-presupuesto='".$row['monto_presupuesto']."'>
                                            <img src='../vista/img/editar.png' alt='editar'>
                                        </a>
                                        <a href='?eliminarId=".$row['id_item']."&idProyecto=".$idProyecto."&idCategoria=".$idCategoria."' class='btn-rojo'>
